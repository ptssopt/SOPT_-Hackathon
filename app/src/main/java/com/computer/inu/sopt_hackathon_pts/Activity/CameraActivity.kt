...
class CameraActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        ovalcopy.visibility=View.GONE
        iv_camera_iv.setOnClickListener {
            requestReadExternalStoragePermission()
        }
        ovalcopy.setOnClickListener {
...
//Uri를 getRealPathFromURI라는 메소드를 통해 절대 경로를 알아내고, 인스턴스 변수 imageURI에 넣어줍니다!
                    Glide.with(this)
                        ...
                        .thumbnail(0.1f)
                        .into(iv_finish)
                    iv_camera_iv.visibility=View.GONE
                    iv_finish.visibility=View.VISIBLE
                    oval.visibility=View.VISIBLE
                    ovalcopy.visibility=View.VISIBLE
